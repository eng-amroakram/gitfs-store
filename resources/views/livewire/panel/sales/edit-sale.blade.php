        ...
        <div class="card-body">
            <form wire:submit.prevent="update">
                ...
                <div class="mb-4">
                    ...
                    <textarea id="description" wire:model.defer="description" class="form-control" rows="2"></textarea>
                    @error('description')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
...
@push('scripts')
    <script>
        $(document).ready(function() {
            ...
            if ($customer) {
                const $customerSelector = document.querySelector("#customer");
                const $customerSelectInstance = mdb.Select.getInstance($customerSelector);
                $customerSelectInstance.setValue($customer);
            }
